...
MyGame = ig.Game.extend({
	...
	drawMainScreen: function() {
		ig.game.ctx.beginPath();
		ig.game.ctx.fillStyle = 'rgba(255,255,255,' + this.beatGuideAlpha + ')';
		...
		ig.game.ctx.beginPath();
		ig.game.ctx.fillStyle = '#7e0302';
		ig.game.ctx.fillRect(0, ig.system.height - 15, ig.system.width / 240.55 * ig.music.currentTrack.currentTime, 15);
	},
