...
EntityGuide = ig.Entity.extend({
    ...
    sizeValue: 0.5,     // Points for size matching
	...
	init: function(x, y, settings) {
        ...
        switch (this.kind) {
            ...
            case 'purple':
                ...
                break;
            case 'beat':
                ig.game.beatGuide = this;
                this.pos.y = ig.system.height;
                this.targetColor = this.gray;
                this.guideContractionSpeed = 0.55 * ig.system.height;
    ...
    update: function() {
        ...
        if (this.kind !== 'beat') {
            ...
            // Contract radius when it's time to die
                ...
                if (this.radius <= 0) {
                    if (this.childSet) {
                        this.tempPoints = Math.round((this.posValue + this.sizeValue) * 100);
            ...
            if (this.childSet) {
                ...
                if (this.child) {
                    ...
                    if (!this.active) {
                        minus = radiusOffsetPoints / 1500; // If contracting, be more lenient as player has less warning
                    }
                    else {
                        minus = radiusOffsetPoints / 100; // When expanding remove more points as player has more warning
                    }
                }
        ...
        // If this is a beat guide
            ...
            // Kill when beat guide is too high
                ...
                ig.game.spawnEntity(EntityPoints, this.pos.x, this.pos.y + 50, {points: ig.game.controller.beatPoints});
